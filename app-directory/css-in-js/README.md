...
```bash
npx create-next-app --example https://github.com/vercel/examples/tree/main/app-directory/css-in-js
# or
yarn create next-app --example https://github.com/vercel/examples/tree/main/app-directory/css-in-js
```
