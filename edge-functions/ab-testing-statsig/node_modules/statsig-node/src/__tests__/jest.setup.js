...
const mock_noAllocLayerConfigSpec = {
...
const mock_allocatedLayerConfigSpec = {
  name: 'allocated_layer',
  type: 'dynamic_config',
...
const exampleConfigSpecs = {
  ...
  allocated_layer: mock_allocatedLayerConfigSpec,
  unallocated_layer: mock_noAllocLayerConfigSpec,
};
