...
async function getPageStaticInfo(params) {
    ...
    if (/runtime|getStaticProps|getServerSideProps|export const config/.test(fileContent)) {
        ...
        resolvedRuntime = _constants.SERVER_RUNTIME.edge === resolvedRuntime ? _constants.SERVER_RUNTIME.edge : requiresServerRuntime ? resolvedRuntime || ((ref15 = nextConfig.experimental) == null ? void 0 : ref15.runtime) : undefined;
