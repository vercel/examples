  ...
  return (
    <Page>
      ...
      <Text className="mb-4">
        ...
        uses Middleware to split traffic between two pages at the edge. 
        It also uses cookies to ensure the same user always sees the same variation.
      </Text>
      <Text className="mb-4">
      ...
      <List className="mb-4">
        <li><Code>pages/index.tsx</Code>, the existing homepage</li>
        <li><Code>pages/new_homepage.tsx</Code>, the new page we want to test</li> 
      </List>
      <Text className="mb-4">
        We want to run an A/B test where 50% of users who visit the homepage (<Code>/</Code>) will be served the new version instead of the original. 
      ...
      <Text className="mb-4">
        In <Code>middleware.tsx</Code>, we use the GrowthBook SDK to randomly split traffic between these pages.
      </Text>
      <Text className="mb-4">
...
async function getFeatures() {
  ...
  return res
      ...
      <List>
        <li className="mb-2">
          GitHub Repo - <Link href="https://github.com/growthbook/growthbook">
            github.com/growthbook/growthbook →
          </Link>
        </li>
        <li className="mb-2">
          Documentation - <Link href="https://docs.growthbook.io/">docs.growthbook.io →</Link>
        </li>
        <li className="mb-2">
          Website - <Link href="https://www.growthbook.io/">www.growthbook.io →</Link>
        </li>
      </List>
    </Page>
  )
