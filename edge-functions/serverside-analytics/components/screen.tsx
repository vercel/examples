...
export const Screen = () => {
  const { data } = useSwr('/views', fetchAPI, { refreshInterval: 500 })
  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <Text>
        ...
        <Button className="ml-4" onClick={handleSwitchPage}>
          Switch Page
        </Button>
      </Text>
      <Text>
        ...
        table. To keep the function light and quick, we are using their rest API
...
`}
      ...
      <Text>
        In order to also capture client-side navigations we can make use of the{' '}
        <Code>routeChangeComplete</Code> event provided by{' '}
