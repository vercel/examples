...
<main class="py-10 relative flex flex-col items-center justify-center min-h-screen">
	<a
	...
	<div class="flex flex-col grow">
		<a href="https://vercel.com">
			<img
				src="/vercel.svg"
				alt="Vercel Logo"
				class="dark:text-white text-white my-2"
				width={100}
				height={24}
			/>
		</a>
		<a
			...
			class="mt-auto flex items-center h-8 space-x-2 bottom-20 right-20"
		>
