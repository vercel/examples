	...
	<main class="relative flex flex-col items-center justify-center min-h-screen py-10">
		...
		>
			<div class="mb-6 text-lg text-center">
				Displayed below is the total number of page views for this demo. Refresh the page and watch
				it increase!
			</div>
			<button @click="refreshPage()" class="mb-6 font-bold underline opacity-70 hover:opacity-100">
				Refresh Page
			</button>
