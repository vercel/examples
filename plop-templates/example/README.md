...
```bash
npx create-next-app --example https://github.com/vercel/examples/tree/main/-- PLOP PATH HERE --
# or
yarn create next-app --example https://github.com/vercel/examples/tree/main/-- PLOP PATH HERE --
```
