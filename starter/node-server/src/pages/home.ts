...
<body>
    ...
    <main>
        <div class="hero">
            <h1>server.ts</h1>
            <div class="hero-code">
                <pre><code><span class="keyword">import</span> { <span class="function">createServer</span> } <span class="keyword">from</span> <span class="string">'node:http'</span>

<span class="keyword">const</span> <span class="variable">server</span> = <span class="function">createServer</span>((<span class="variable">request</span>, <span class="variable">response</span>) => {
  <span class="variable">response</span>.<span class="function">writeHead</span>(<span class="variable">200</span>, { <span class="string">'Content-Type'</span>: <span class="string">'application/json'</span> })
  <span class="variable">response</span>.<span class="function">end</span>(<span class="function">JSON.stringify</span>({ <span class="string">Node</span>: <span class="string">'on Vercel'</span> }))
})

<span class="variable">server</span>.<span class="function">listen</span>(<span class="variable">3000</span>)</code></pre>
            </div>
        </div>
