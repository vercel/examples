      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-3">
            ...
            <a
              href="https://github.com/vercel/examples/tree/main/cdn/api-proxy-rewrite#in-code-alternative-approach"
              className="flex-1 inline-flex items-center justify-center border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 px-5 py-2.5 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors text-sm"
            >
...
function PostCard({ post }: { post: Post }) {
  return (
    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-6 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
      ...
      <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2 leading-snug capitalize">
        {post.title}
      </h3>
