          ...
          <ul className="flex items-center content-center">
            ...
            <li className="font-medium" style={{ letterSpacing: '.01px' }}>
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                href="https://github.com/vercel/examples/tree/main/flags-sdk/flags-sdk-template"
              >
                Vercel Examples / Flags SDK / flags-sdk-template
              </Link>
            </li>
          </ul>
        </div>
          ...
          <nav className="flex-row inline-flex items-center">
            ...
            <span className="ml-2 h-full flex items-center cursor-not-allowed text-accents-5">
              <Link
                ...
                href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fexamples%2Ftree%2Fmain%2Fflags-sdk%2Fflags-sdk-template&env=FLAGS_SECRET&envDescription=The+FLAGS_SECRET+will+be+used+by+the+Flags+Explorer+to+securely+overwrite+feature+flags.+Must+be+32+random+bytes%2C+base64-encoded.+Use+the+generated+value+or+set+your+own.&envLink=https%3A%2F%2Fvercel.com%2Fdocs%2Fworkflow-collaboration%2Ffeature-flags%2Fsupporting-feature-flags%23flags_secret-environment-variable&project-name=flags-sdk-template&repository-name=flags-sdk-template"
                target="_blank"
                rel="noreferrer"
              >
                Clone & Deploy
