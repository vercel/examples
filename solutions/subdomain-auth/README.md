...
```bash
npx create-next-app --example vercel/examples/tree/main/solutions/subdomain-auth subdomain-auth
# or
yarn create next-app --example vercel/examples/tree/main/solutions/subdomain-auth subdomain-auth
```
